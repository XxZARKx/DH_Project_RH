...
const CardAuto = ({ vehicle }) => {
	return (
		<div className="w-full bg-[#ffffff] h-full border-solid border flex flex-col items-center justify-between p-5 rounded-2xl cardAuto hover:scale-[1.1] transition-all ease-in-out duration-[.7s]">
			<img
